...
public class FilterConfigImpl implements FilterConfig
{
	...
	public FilterConfigImpl(String strName, ServletContext sc, Properties propInit)
	{
		_propInit = propInit; 
		_strName = strName;
		_sc = sc;
	...
	public void setFilterName(String strName) { _strName = strName; }
	public String getFilterName() { return _strName; }
}
